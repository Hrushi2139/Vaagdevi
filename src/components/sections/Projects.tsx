...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-24 px-4 bg-[#F7F4ED]">
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <h2 className="text-4xl font-display playfair text-[#1A1A1A] mb-4">
            Signature Projects
          </h2>
          ...
          {categories.map((cat) => (
            <motion.button
              ...
              className={cn(
                ...
                activeCategory === cat
                  ? "gold-gradient text-white shadow-lg shadow-[#D4AF37]/30"
                  : "bg-transparent text-[#1A1A1A] border-2 border-[#D4AF37]/30 hover:border-[#D4AF37] hover:text-[#D4AF37]"
              )}
            >
              {cat}
            </motion.button>
                ...
                >
                  <Link href={`/projects/${project._id}`} className="block h-full">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 border-2 border-transparent rounded-2xl group-hover:border-[#D4AF37]/60 group-hover:shadow-[0_0_40px_rgba(212,175,55,0.3)] transition-all duration-500" />
                    </motion.div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 z-30 p-6">
                      ...
                      >
                        <motion.p className="text-[#D4AF37] text-sm font-semibold mb-2">
                          {project.plotSize}
                        </motion.p>
                        ...
                        <motion.div className="flex items-center gap-1 text-[#D4AF37] text-sm font-semibold">
